...
import com.danimo.restaurant.common.application.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<RestApiError> handleOrderNotFoundException(OrderNotFoundException e) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(new RestApiError(HttpStatus.NOT_FOUND.value(), e.getMessage()));
    }
    ...
    public ResponseEntity<RestApiError> handleOrderAlreadyCompletedException(OrderAlreadyCompletedException e) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(new RestApiError(HttpStatus.BAD_REQUEST.value(), e.getMessage()));
    }
